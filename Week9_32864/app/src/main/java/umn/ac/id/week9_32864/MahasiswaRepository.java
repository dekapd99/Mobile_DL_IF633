...
public class MahasiswaRepository {
    ...
    public void insert(Mahasiswa mhs){new insertAsyncTask(daoMahasiswa).execute(mhs);
    }

    public void deleteAll(){new deleteAllAsyncTask(daoMahasiswa).execute();
    }

    public void delete(Mahasiswa mhs) {new deleteAsyncTask(daoMahasiswa).execute(mhs);
    }

    public void update(Mahasiswa mhs) {new updateAsyncTask(daoMahasiswa).execute(mhs);
    }
